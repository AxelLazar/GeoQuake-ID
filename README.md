...
🌐 **Demo:** https://geo-quake-id.vercel.app/
...
- **Chart 4: Bubble Chart** — Peta persebaran koordinat gempa di Indonesia (lon/lat), ukuran bubble proporsional terhadap magnitudo
